...
use profile::bpf::{PythonSkelBuilder};
...
pub fn main() {
    ...
    let skel_builder = PythonSkelBuilder::default();
    ...
    ring_buf.add(maps.memperf_output(), |v| {
